...
# save LFC table
write_csv(differential_phosphorylated_peptides, "results/dpp_{{case}}_{{ctrl}}_{{chip}}.csv")
...
krsa_heatmap(data_modeled$normalized, significant_peptides$meanLFC$`0.2`, groups = c("{{case}}", "{{ctrl}}"), scale = "row", width = 6, height = 8)
...
saveRDS(mutiple_krsa_outputs, file = "multiple_krsa_output_{{case}}_{{ctrl}}_{{chip}}.RDS")
...
# krsa_top_hits(AvgZTable2, {{threshold}}) -> kinases_hits
AvgZTable2 %>%
