---
title: "My Thesis"
subtitle: STK analysis - Without Chip 19, Male Vehicle and Male Insulin
date: "8-24-2023"
...
params:
  ...
  signal_file: "signal.txt" # Change the file name to the one you have
  saturation_file: "saturation.txt" # Change the file name to the one you have
...
qc_data <- krsa_qc_steps(raw_data) %>% 
  mutate(
  Group = case_when(
    SampleName == "1" ~ "Female_Veh",
    SampleName == "2" ~ "Female_Ins",
    SampleName == "3" ~ "Male_Veh",
    SampleName == "4" ~ "Male_Ins",
    TRUE ~ SampleName
  ),
